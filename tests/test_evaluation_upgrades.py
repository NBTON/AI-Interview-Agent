# tests/test_evaluation_upgrade.py
import os
import sys
import json
...
class TestEvaluationUpgrade:
    """Test suite for evaluation upgrades - MCQ, code execution, scoring, adaptive branching"""
    
    @classmethod
    def setup_class(cls):
        cls.rubric = {"excellent": "Detailed", "good": "Good", "weak": "Weak"}

    def test_deterministic_mcq(self):
        """Test MCQ evaluation - exact, letter, and partial matches"""
        question_obj = {
    ...
    def test_deterministic_true_false(self):
    ...
    def test_code_execution_assertion_failure(self):
        """Test code with assertion failure"""
        code = "def add(a, b):\n    return a - b"
        test_script = "add(2, 3) == 5"
    ...
    def test_code_execution_blocks_disallowed_modules(self):
        """Test code execution sandbox guard"""
        code = "import os\n\ndef add(a, b):\n    return a + b"
        test_script = "add(2, 3) == 5"
    ...
    def test_nested_score_payload_aggregates_turn_scores(self):
        """Test nested score payload aggregation"""
    ...
    def test_adaptive_branching_keeps_light_skipped_topic(self):
        """Test adaptive branch keeps light coverage for skipped topic"""
    ...
    def test_evaluate_answer_integration(self):
        """Test evaluate_answer integration for coding and MCQs"""
        # MCQ
    ...
    def test_evaluate_answer_with_mock(self, mock_llm):
        ...
        # Accept score >= 2 (mock should work, but fallback is 2)
